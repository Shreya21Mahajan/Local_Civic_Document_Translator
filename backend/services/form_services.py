...
class FormDefinition:
    ...
    def __init__(self, form_id: str, title: str, fields: List[Dict[str, Any]]):
        ...
        self.title = title
        self.fields = fields # List of field configs
    ...
    fields=[
        {
            ...
            "type": FieldType.TEXT,
            "required": True,
            "mapping_keys": ["PERSON"], # Maps NLP entity 'PERSON' to this field
        ...
        },
        {
            ...
            "type": FieldType.TEXT,
            "required": True,
            "mapping_keys": ["GPE"], # Geo-Political Entity
